...
Throughout your first few weeks at GitLab it is important to focus on the onboarding issue. The onboarding issue is specific to you, for an idea what is in there please see the [template](https://gitlab.com/gitlab-com/peopleops/blob/master/.gitlab/issue_templates/onboarding.md). This guide will help you understand what is in the onboarding issue, and why we are asking you to complete the items on the issue.

#### Getting Started

* Prepare for your first [Team Call](https://about.gitlab.com/handbook/communication/#team-call). In the calendar invite is a link to the Team Call agenda. The first time that you join, please make sure that you connect at least 10 minutes before the call in order to download Zoom and make sure that your camera and
microphone are working properly. We'd like you to introduce yourself to the team (±1 minute), so please prepare three talking points for yourself. Please make sure to tell us about where you were before GitLab, why you wanted to join our team, and what you like to do in your spare time.
...
1. Since we are a global organization understand your benefits might be different than other team members at the company based on which [contract](https://about.gitlab.com/handbook/contracts/) you signed. It is important to understand **your** [benefits](https://about.gitlab.com/handbook/benefits/). If you have questions please reach out to People Ops.
  * Notable Benefits that apply to all team members:
    1. [No ask time off policy](https://about.gitlab.com/handbook/paid-time-off): GitLab truly does value a work-life balance, and encourages team members to have a flexible schedule and take vacations. If you feel uncomfortable about taking time off, or are not sure how much time to take off throughout the year, feel free to speak with your manager or People Operations. We will be happy to reinforce this policy! Please note the additional steps that might need to be taken if you are scheduled for [on call](https://about.gitlab.com/handbook/on-call).
...
[Create a new **confidential** issue](https://gitlab.com/gitlab-com/peopleops/issues/new) for new hire in organization using the `onboarding` template [from the dropdown](https://docs.gitlab.com/ce/user/project/description_templates.html#using-the-templates).
...
Please [update the list](https://gitlab.com/gitlab-com/peopleops/edit/master/.gitlab/issue_templates/onboarding.md) as more steps arise, and then also update the associated item on the [offboarding list](https://gitlab.com/gitlab-com/peopleops/blob/master/.gitlab/issue_templates/offboarding.md).
...
Please schedule a call with your manager.

#### 60-day Onboarding Survey

Please see [the NPS section](/handbook/people-operations/#nps-surveys) of our handbook.
