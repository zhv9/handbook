...
[Gifox](http://gifox.io/) is the absolute best option here, although a paid app, its reasonably priced ($3.99). It has support for all of the features, shortcuts, and then some.
