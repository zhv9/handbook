...
1. If you need an invitation letter for a visa appointment at the Greek Embassy, please fill out this [form](https://docs.google.com/a/gitlab.com/forms/d/e/1FAIpQLSej8BdtGkKWN7aKHN2SRukPGgqKYiDjiaNCZN8WlluhdCpEzw/viewform). An email will be sent to People Ops to verify all information and will then be forwarded to you.
...
Employees who are recruited from abroad can indeed apply (by themselves or with help from the company) for the [30% tax ruling](https://www.expatax.nl/30ruling). However, there are some conditions which need to be checked before applying to see whether the employee is (still) eligible.
...
- When using the [move calculator](https://about.gitlab.com/jobs/move/) do you meet the Dutch salary requirement for [highly skilled migrants younger than 30 years](https://ind.nl/en/Pages/income.aspx).
- You are not older than 27 years.
- You have been a team member at GitLab for 2 years
- You are not on a PIP
