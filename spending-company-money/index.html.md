...
1. Spend company money like it is your **own** money. _[No, really](https://gitlab.slack.com/messages/search/"Spending%20Company%20Money"%20in:%23peopleops/)_.
...
1. You may privately use GitLab property, a MacBook for example, to check your private e-mails or watch a movie as long as it does not violate law, harm GitLab, or interfere with [Intellectual Property](/handbook/general-guidelines/#sts=Intellectual Property).
...
1. **Items.** The company will pay for the following items if you **need it for work or use it mainly for business**, and local law allows us to pay for it without incurring payroll taxes. Items paid for by the company are property of the company and need to be reported with serial numbers etc. to People Ops for proper [asset tracking](/handbook/finance/#asset-tracking). Since these items are company property, you do not need to buy insurance for them unless it is company policy to do so (for example, at the moment we do not purchase Apple Care), but you do need to report any loss or damage to PeopleOps as soon as it occurs. Links in the list below are to sample items, other options can be considered:
    *  Notebook:
        * Engineers - We recommend getting a [MacBook Pro 13-inch retina with Intel Core i7, 512GB of storage, and 16GB of memory](http://www.apple.com/shop/buy-mac/macbook-pro) or similar.
        * Solutions Architects - We recommend getting a [MacBook Pro 13-inch retina with 256GB of storage and 16GB of memory](http://www.apple.com/shop/buy-mac/macbook-pro)
        * Others - We recommend getting a [MacBook Pro 13-inch retina with 256GB of storage and 8GB of memory](http://www.apple.com/shop/buy-mac/macbook-pro)
        * Mention to the Apple Store that you are buying it for GitLab so that we can qualify for [business discounts](http://www.apple.com/business/vpp/), 7% on all Macbooks, 3% on iPhones/iPads, and 10% off accessories, except for the apple watch, Bose products, and apple pencil. Note that not all stores can honor this discount.  If that is the case for your store, please reach out to People Ops for how to proceed.
        * We do not allow you to purchase non-Apple computers because we will manage our machines with [Fleetsmith](https://www.fleetsmith.com/). You will need an Apple laptop instead of an iMac when you attend our [company summit](https://about.gitlab.com/culture/summits/). Apart from Fleetsmith only supporting Macs there are other reasons why Windows and Linux are not an option. Windows makes it harder to work with git and ruby from the command line. Linux doesn't support WebEx screen sharing while it is one of the more common conferencing tools used with customers that we all need to interact with from time to time. Also note that 1password doesn't have a native client for Linux and the web interface in Firefox is not that good.
    ...
    *  Ergonomic [chair](https://www.amazon.com/Merax-Ergonomic-Adjustable-Office-Reclining/dp/B01MXEP6BU/ref=sr_1_5_m?s=home-garden&ie=UTF8&qid=1487280101&sr=1-5&keywords=Merax%2Bergonomic%2Bchair&th=1) ([EU](https://www.amazon.de/Topstar-OP290UG20-Syncro-Bandscheiben-Drehstuhl-Deluxe-schwarz/dp/B00M6AJWHY/))
...
1. **Expenses.** The company will reimburse for the following expenses if you need it for work or use it mainly for business, and local law allows us to pay for it without incurring taxes:
    ...
    *  For travel to other team members please see our [visiting grant](/handbook/incentives/#work-remotely-travel-grant).
